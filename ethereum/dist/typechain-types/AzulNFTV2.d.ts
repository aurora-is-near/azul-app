...
export interface AzulNFTV2Interface extends utils.Interface {
    functions: {
    ...
    encodeFunctionData(functionFragment: "temp", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "temp", data: BytesLike): Result;
...
export interface AzulNFTV2 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AzulNFTV2Interface;
    ...
    functions: {
        ...
        temp(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    populateTransaction: {
        ...
        temp(overrides?: CallOverrides): Promise<PopulatedTransaction>;
