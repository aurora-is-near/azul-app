...
export interface AzulNFTInterface extends utils.Interface {
  functions: {
    ...
    "createEdition(string,string)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "rawDataFromPasscodeHash",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "rawDataFromTokenId",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "uploadPasscodeBatch",
...
export interface AzulNFT extends BaseContract {
  ...
  functions: {
    ...
    rawDataFromPasscodeHash(
      passcodeHash: BytesLike,
      overrides?: CallOverrides
  ...
  callStatic: {
    ...
    claim(passcode: string, overrides?: CallOverrides): Promise<void>;
